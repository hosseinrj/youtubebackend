...
firebase_admin.initialize_app(cred, {'storageBucket': 'bubu-99bcd.appspot.com'})
db = firestore.client()
bucket = storage.bucket()

def generate_start_keyboard():
    keyboard = InlineKeyboardMarkup()
    keyboard.add(InlineKeyboardButton("Open BuBu App", web_app=WebAppInfo(url="https://youtube-mu-steel.vercel.app/")))
    return keyboard
